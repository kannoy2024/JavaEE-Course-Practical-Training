<template>
  <div class="bg">
    <div
        style="width: 350px;background-color: #eaeaea;opacity: 89% ;border-radius: 5px;box-shadow: 0 0 10px black;padding:40px 20px">
      <el-form ref="formRef" :model="data.form" :rules="data.rules" status-icon>
        <div class="rainbow-text" style="margin-bottom: 40px;text-align: center;font-weight: bold;font-size: 24px">
          欢迎注册
        </div>
        ...
        <div style="margin-bottom: 20px">
          <el-button style="width: 100% ;background-color: lime ; border-color: lime" type="primary" size="large"
                     @click="register">注册
          </el-button>
        </div>
